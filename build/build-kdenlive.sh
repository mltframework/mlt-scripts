...
function set_globals {
  ...
  #####
  # ffmpeg
  CONFIG[0]="./configure --prefix=$FINAL_INSTALL_DIR --disable-doc --enable-gpl --enable-version3 --enable-shared --disable-static --enable-debug --enable-pthreads --enable-runtime-cpudetect"
  ...
  #######
  # eigen
  CONFIG[11]="cmake -DCMAKE_INSTALL_PREFIX=$FINAL_INSTALL_DIR .."
}
